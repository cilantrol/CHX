...
<div class="positionbg">
    <div id="position" class="wrap">
        ...
        <a href="/">Home</a>&nbsp;&gt;&nbsp;<a class="last" href="SnowMeltingMat.asp"><%=title_en%></a>
    </div>
</div>
...
<div class="wrap" style="position:relative; min-height:600px;">
    <div class="leftside">
        <div class="leftmenu">
            <div class="item cur"><a href="SnowMeltingMat.asp" title="Snow Melting Mat">Snow Melting Mat</a></div>
    ...
    <div class="rightside fr">
        <div id="pdetail">
            <%
			picitem = ""
			sql = "select top 5 * from pro_pic where pid = 1 order by px asc,id desc"
