...
<div class="positionbg">
    <div id="position" class="wrap">
        ...
        <a href="/">Home</a>&nbsp;&gt;&nbsp;<a class="last" href="UnderfloorHeatingCable.asp"><%=title_en%></a>
    </div>
</div>
...
<div class="wrap" style="position:relative; min-height:600px;">
    <div class="leftside">
        <div class="leftmenu">
            ...
            <div class="item cur"><a href="UnderfloorHeatingCable.asp" title="Underfloor Heating Cable">Underfloor Heating Cable</a></div>
            <div class="item"><a href="UnderDeskHeater.asp" title="Under Desk Heater">Under Desk Heater</a></div>
        </div>
    </div>
    ...
    <div class="rightside fr">
        <div id="pdetail">
			<%
			picitem = ""
			sql = "select top 5 * from pro_pic where pid = 3 order by px asc,id desc"
