...
"<tr>" & _
"<td align=center>Copyright  &copy;  2003-2011  <b>eWebEditor<font color=#CC0000>.net</font></b> <b>eWebSoft<font color=#CC0000>.com</font></b>, All Rights Reserved .</td>" & _
"</tr>" & _
"<tr>" & _
...
If s_Domain="127.0.0.1" Or s_Domain="localhost" or s_Domain=LCase(Request.ServerVariables("SERVER_NAME")) Then
   CheckLicense = True
   Exit Function
End If
If sLicense="" Then	
