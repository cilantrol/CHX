...
<div class="positionbg">
    <div id="position" class="wrap">
        ...
        <a href="/">Home</a>&nbsp;&gt;&nbsp;<a class="last" href="FloorHeatingSystems.asp"><%=title_en%></a>
    </div>
</div>
...
<div class="wrap" style="position:relative; min-height:600px;">
    <div class="leftside">
        <div class="leftmenu">
            ...
            <div class="item cur"><a href="FloorHeatingSystems.asp" title="Floor Heating Systems">Floor Heating Systems</a></div>
    ...
    <div class="rightside fr">
        <div id="pdetail">
			<%
			picitem = ""
			sql = "select top 5 * from pro_pic where pid = 2 order by px asc,id desc"
